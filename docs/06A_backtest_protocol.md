...
Next Rebalance Period Return으로 정의한다.
...
따라서 프로젝트 설명에서 completely Unseen 2026 Holdout 이라고 표현하지 않는다.

대신Walk-Forward OOS Evaluation Period의 일부로 취급한다.
